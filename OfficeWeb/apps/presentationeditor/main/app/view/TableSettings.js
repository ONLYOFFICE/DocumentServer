 ...
 *
 */
 Ext.define("PE.view.TableSettings", {
    extend: "Common.view.AbstractSettingsPanel",
    alias: "widget.petablesettings",
    height: 488,
    requires: ["Common.component.ThemeColorPalette", "Ext.button.Button", "Ext.form.Label", "Ext.form.field.ComboBox", "Ext.container.Container", "Ext.toolbar.Spacer", "Ext.Array", "Ext.menu.Menu", "Ext.menu.Manager", "PE.view.InsertTableDialog", "Ext.data.Model", "Ext.data.Store", "Ext.XTemplate", "PE.view.TableSettingsAdvanced", "Common.component.ComboDataView", "Common.plugin.ComboBoxScrollPane"],
                        ...
                        select: Ext.bind(function (picker, color, eOpts) {
                            ...
                            if (this.api) {
                                ...
                                if (this.CellColor.Color == "transparent") {
                                    ...
                                    fill.get_fill().put_color(this.getRgbColor(this.CellColor.Color));
                                }
                                background.put_fill(fill);
                                this.api.tblApply(properties);
                            }
                            this.fireEvent("editcomplete", this);
                        },
    ...
    hideMenus: function () {
        ...
        this._cmbTableTemplate.dataMenu.hide();
        this._btnEdit.hideMenu();
    },
