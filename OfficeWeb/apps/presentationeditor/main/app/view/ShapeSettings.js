 ...
 *
 */
 Ext.define("PE.model.ModelBorders", {
...
Ext.define("PE.view.ShapeSettings", {
    ...
    ChangeSettings: function (props) {
        ...
        if (props) {
            ...
            this.SuspendEvents();
            this._noApply = true;
            this.disableFillPanels(!props.get_CanFill());
            var rec = null;
