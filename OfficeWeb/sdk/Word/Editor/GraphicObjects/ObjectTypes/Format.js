...
CGradFill.prototype = {
    ...
    IsIdentical: function (fill) {
        ...
        if ((this.lin == null && fill.lin != null) || (this.lin != null && fill.lin == null)) {
            return false;
        }
        if (isRealObject(this.lin)) {
            if (this.lin.angle != fill.lin.angle || this.lin.scale != fill.lin.scale) {
                return false;
            }
        }
        if ((this.path == null && fill.path != null) || (this.path != null && fill.path == null)) {
            return false;
        }
...
function CXfrm() {
    ...
    this.setPosition = function (posX, posY, model_id) {
        History.Add(g_oUndoRedoDrawingObject, historyitem_AutoShapes_Offset, model_id, null, {
            object: this,
            data: {
                oldX: this.offX,
                oldY: this.offY,
    ...
    this.setExtents = function (extX, extY, model_id) {
        History.Add(g_oUndoRedoDrawingObject, historyitem_AutoShapes_Extents, model_id, null, {
            object: this,
            data: {
                oldExtX: this.extX,
                oldExtY: this.extY,
    ...
    this.setChildOffsets = function (chOffX, chOffY, model_id) {
        History.Add(g_oUndoRedoDrawingObject, historyitem_AutoShapes_Child_Offset, model_id, null, {
            object: this,
            data: {
                oldChOffX: this.chOffX,
                oldChOffY: this.chOffY,
                newChOffX: chOffX,
                newChOffY: chOffY
            }
        });
    ...
    this.setChildExtents = function (chExtX, chExtY, model_id) {
        History.Add(g_oUndoRedoDrawingObject, historyitem_AutoShapes_Child_Extents, model_id, null, {
            object: this,
            data: {
                oldChExtX: this.chExtX,
                oldChExtY: this.chExtY,
                newChOffX: chExtX,
                newChOffY: chExtY
            }
        });
    ...
    this.setFlips = function (flipH, flipV, model_id) {
        History.Add(g_oUndoRedoDrawingObject, historyitem_AutoShapes_Flips, model_id, null, {
            object: this,
            data: {
                oldFlipH: this.flipH,
                oldFlipV: this.flipV,
