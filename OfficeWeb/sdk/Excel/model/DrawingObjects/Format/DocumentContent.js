...
CDocumentContent.prototype = {
    ...
    addParagraph: function (pos, par) {
        ...
        History.Add(g_oUndoRedoGraphicObjects, historyitem_AutoShapes_AddParagraph, null, null, new UndoRedoDataGraphicObjects(this.Get_Id(), new UndoRedoDataGOSingleProp(pos, newValue)));
